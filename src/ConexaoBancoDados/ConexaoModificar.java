 ...
 * @author Valmir
 */
public class ConexaoModificar {

    private String sql;
    private String caminho = "jdbc:mysql://localhost:3306/s";
    private String caminhoPostgre = "jdbc:postgresql://localhost:5432/Emprestimo";
                                   
    private String usuario = "root";
    private String usuarioPostgre = "postgres";
    private String senha = "mysql";
    private String senhaPostgre="fcat2015";
    ...
    public void conexaoBanco() {
        ...
        try {
            ...
            con = DriverManager.getConnection(caminhoPostgre, usuarioPostgre, senhaPostgre);
